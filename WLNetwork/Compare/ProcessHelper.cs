...
namespace KellermanSoftware.CompareNetObjects
{
    ...
    public static class ProcessHelper
    {
        ...
        public static int Shell(string executablePath, string arguments, ProcessWindowStyle windowStyle,
            bool waitUntilFinished)
        {
            ...
            try
            {
                ...
                string assemblyPath = Path.Combine(FileHelper.GetCurrentDirectory(),
