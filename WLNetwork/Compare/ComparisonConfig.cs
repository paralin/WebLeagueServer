...
namespace KellermanSoftware.CompareNetObjects
{
    ...
    public class ComparisonConfig
    {
        ...
        /// <summary>
        ///     Ignore millisecond differences between DateTime values or DateTimeOffset values.  The default is 0 (any time
        ...
        /// <summary>
        ///     If a class implements an interface then only members of the interface will be compared.  The default is all members
        ///     are compared.
        /// </summary>
        ...
        /// <summary>
        ///     Ignore Data Table Names, Data Table Column Names, properties, or fields by name during the comparison. Case
        ///     sensitive. The default is to compare all members.
        /// </summary>
        /// <example>MembersToIgnore.Add("CreditCardNumber")</example>
        public List<string> MembersToIgnore { get; set; }

        /// <summary>
        ///     Only compare elements by name for Data Table Names, Data Table Column Names, properties and fields. Case sensitive.
        ///     The default is to compare all members.
        /// </summary>
...
#if !PORTABLE
        /// <summary>
        ///     If true, private properties and fields will be compared. The default is false.  Silverlight and WinRT restricts
        ///     access to private variables.
        /// </summary>
        public bool ComparePrivateProperties { get; set; }

        /// <summary>
        ///     If true, private fields will be compared. The default is false.  Silverlight and WinRT restricts access to private
        ///     variables.
        /// </summary>
        ...
        /// <summary>
        ///     If true, compare each item within a collection to every item in the other.  The default is false. WARNING: setting
        ///     this to true significantly impacts performance.
        /// </summary>
        ...
        /// <summary>
        ///     Reflection properties and fields are cached. By default this cache is cleared after each compare.  Set to false to
        ///     keep the cache for multiple compares.
        /// </summary>
        /// <seealso cref="Caching" />
        public bool AutoClearCache { get; set; }

        /// <summary>
        ///     By default properties and fields for types are cached for each compare.  By default this cache is cleared after
        ///     each compare.
        /// </summary>
